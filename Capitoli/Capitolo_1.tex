...
\end{figure}
\input{Immagini/schema_statico_sospeso}
...
\begin{figure}
	\centering
	\subfloat[\emph{Schema a ventaglio}]{\includegraphics[width=11.8cm]{Immagini/cable_stayed_bridge_ventaglio}\label{fig:cable_stayed_ventaglio}}\\
	\subfloat[\emph{Schema a semi--ventaglio o "ventaglio modificato"}]{\includegraphics[width=11.8cm]{Immagini/cable_stayed_bridge_semiventaglio}\label{fig:cable_stayed_semiventaglio}}\\
	\subfloat[\emph{Schema ad arpa}]{\includegraphics[width=11.8cm]{Immagini/cable_stayed_bridge_arpa}\label{fig:cable_stayed_arpa}}
	\caption{Schemi delle varie tipologie di ponti strallati}
	\label{fig:cable_stayed_bridge}
\end{figure}

\input{Immagini/schema_statico_strallato}
